...
?>
	...
	<section class="page-head wrap" style="background-image: url('/img/articles.png');">
		<div class="container">
			...
			<h1>Блог</h1>
			<p>Статьи о дата-центре и технологиях</p>
		</div>
	</section>
	...
	<section class="page-content useful-articles wrap wrap--gray">
		...
		<div class="u-ta-center u-mb-5">
			<button class="button transparent darker">
				Показать еще
		...
		<div class="container">
			<h2 class="u-mb-5">Полезные статьи</h2>
		...
		<div class="u-ta-center">
			<button class="button transparent darker u-mt-3 u-mb-5">
				Показать еще
				<div class="button-icon-wrapper">
					<img src="img/icons/down-arrow.svg" alt="">
				</div>
