  ...
  <section class="page-head wrap" style="background-image: url('/img/arenda.png');">
    <div class="container">
      <div class="breadcrumbs">
        <p>Главная</p>
        <a href="" class="current-page">Размещение серверов(co-location)</a>
      </div>
      <h1>Размещение серверов(co-location)</h1>
    </div>
  </section>
    ...
    <div class="container">
      <div class="tile-items">
        ...
        <div class="tile__item tile__item--text">
          ...
          <p>Комплекс услуг по размещению серверов в Дата Центре STACK 24 организован на высококачественных инженерных решениях.
            Все энергообеспечение клиентского оборудования, а также его охлаждение зарезервировано по схеме N+1 и отвечает
            высоким требованиям стандарта TIER III. Доступность Ваших серверов - 99,982% в год! В серверных залах Дата Центра
            обеспечивается и гарантируется на уровне SLA температура 22°C (+/- 4°C) и влажность 40% (+/-20%). Предоставляется
            весь перечень телекоммуникационных услуг, большой выбор операторов связи. Круглосуточная техническая поддержка
            и доступ в Дата Центр в формате 24x7x365</p>
        </div>
        ...
        <div class="tile__item">
          <div class="tile__item-content">
            ...
            <h3 class="tile__item-head">Аренда юнит-места</h3>
            <div class="tile__item-text">Услуга предназначена в основном для небольших и средних по размеру компаний, а также для физических лиц, для
        ...
        <div class="tile__item">
          <div class="tile__item-content">
            ...
            <h3 class="tile__item-head">Аренда стойко-места</h3>
            <div class="tile__item-text">Услуга интересна средним и большим компаниям, у которых имеется большой парк сетевого и серверного оборудования,
        ...
        <div class="tile__item">
          <div class="tile__item-content">
            ...
            <div class="tile__item-text">Услуга является уникальной на рынке co-location. Арендуя серверную ячейку клиент получает свой собственный ЦОД
