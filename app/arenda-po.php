...
?>
  ...
  <section class="page-head wrap" style="background-image: url('/img/windows.png');">
    <div class="container">
      <div class="breadcrumbs">
        <p>Главная</p>
        <a href="" class="current-page">Аренда программного обеспечения</a>
      </div>
      <h1>Аренда программного<br> обеспечения Microsoft</h1>
    </div>
  </section>
  ...
  <section class="price-section wrap">
    <div class="container">
      <h2>Стоимость основных продуктов Microsoft</h2>
      <div class="prices-wrap prices-wrap--slider1 owl-carousel">
  ...
  <section class="our-advantages our-advantages--white our-advantages--mt0 wrap">
    <div class="container">
      ...
      <div class="col">
        <div class="col-6">
        <h3>Преимущества аренды лицензионного
программного обеспечения Microsoft</h3>
        <ul class="list list--bold">
          <li>Значительное сокращение расходов</li>
          <li>Высокий уровень безопасности</li>
          <li>Своевременные обновления</li>
          <li>Круглосуточная техническая поддержка</li>
        </ul>
        </div>
        <div class="col-6">
          <h3>Условия Аренды программного 
обеспечения от Microsoft</h3>
          <ul class="list list--bold">
          <li>Возможность использования на арендованныхвыделенных серверах</li>
          <li>Возможность использования в арендованнойвиртуальной  инфраструктуре</li>
          <li>Возможность использования на серверах при аренде 
стойко-место в нашем дата-центре</li>
        </ul>
