...
?>
  ...
  <section class="page-head wrap" style="background-image: url('/img/copy-image.png');">
    <div class="container">
      <div class="breadcrumbs">
        <p>Главная</p>
        <a href="" class="current-page">Резервное копирование</a>
      </div>
  ...
  <section class="page-content wrap">
    <div class="container align-item-center">
      ...
      <div class="page-content__right">
        <p>
            IT любого бизнеса строится на стандартных правилах безопасности. Это Доступность, Целостность и Конфиденциальность. Все эти компоненты не могут существовать без резервирования и возможности создания резервных копий и восстановления данных. Компаниям нужно грамотно оценивать время и стоимость простоя услуг и сервисов. Дата центр STACK 24 может помочь вам сохранить ваш сервис и предложить услуги по резервированию вашей информации. При предоставлении сервиса используются профессиональные программные продукты и работы ведут сертифицированные специалисты. Вы будете получать своевременный отчет по создании резервных копий или работ по восстановлению информации.
        </p>
      </div>
    </div>
  </section>
    ...
    <div class="container align-item-center">
      <div class="page-content__super">
        <div class="page-content__super-left">
          <h3 class="page-content__super-head">Резервное копирование</h3>
          <p class="page-content__super-text">Для уточнения стоимости услуги следует обратиться к нашим специалистам</p>
        </div>
  ...
  <section class="our-advantages our-advantages--white our-advantages--mt0 wrap">
    <div class="container">
      <h3>Услуги по резервированию информации</h3>
      <div class="lists">
        <ul class="list list--bold">
          <li>Резервирование виртуальной инфраструктуры</li>
          <li>Резервирование выделенных серверов</li>
          <li>Создание снимков и резервных копий по расписанию</li>
        </ul>

        <ul class="list list--bold">
          <li>Услуги по долгосрочному хранению информации</li>
          <li>Предоставление дискового пространства под резервные копии</li>
        </ul>
      </div>
